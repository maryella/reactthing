    ...
    <section role="main">
      <div className="container position-relative p-4 w-85 bg-light">
          ...
          <div className="row">
            <div className="col-md-4">
              ...
              <p className="text-justify">
                After a heart attack, your doctor will likely prescribe several
                different medications for you but may not have the time to
                properly explain each one. We give you information about your
                new drugs.
              </p>
            ...
            <div className="col-md-4">
              ...
              <p className="text-justify">
                There are at least 5 types of medication that have been shown to
                help you live longer and prevent heart attack. We help you make
                sure you are taking each one if it's appropriate for you.
              </p>
              <p className="text-center">
                <Link to="/">
                  <button type="button" className="btn btn-outline-danger">
            ...
            <div className="col-md-4">
              ...
              <p className="text-justify">
                ...
                explanation for other providers who notice you're not taking one
        ...
        <footer className="container text-center">
          This product is not intended to diagnose, treat, or prevent any
          disease.
        </footer>
      </div>
    </section>
